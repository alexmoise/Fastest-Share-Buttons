...
Fastest Share Buttons for WordPress - An extremely fast and mobile friendly social share plugin - no JS, no external API, with SVG icons, cache compatible and highly customizable with more than 30 options.
...
[Detailed description, screenshots and guide for Fastest Share Buttons for WordPress](https://moise.pro/fastest-share-buttons-for-wordpress/)
